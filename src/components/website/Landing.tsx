    ...
    <section className={`px-2 h-[100vh] bg-cover bg-center bg-fixed`}  style={{ backgroundImage: `url(${landingImage.src})` }}>
        <div className='pt-[33vh] text-center'>
            ...
            <div className='flex flex-col md:flex-row items-center justify-center gap-8 mt-14'>
              <Link href={'#contact-us'} className='transition-all duration-300 border-2 px-8 py-2 rounded-lg text-white font-medium text-lg w-[200px] hover:border-indigo-600 hover:bg-indigo-600'>Join Us</Link>
              <Link href={'#contact-us'} className='transition-all duration-300 border-2 border-indigo-600 px-8 py-2 bg-indigo-600 rounded-lg w-[200px] text-white font-medium text-lg hover:bg-transparent hover:border-white'>Send Message</Link>
